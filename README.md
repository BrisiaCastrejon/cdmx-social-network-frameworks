...
![Nestle](./src/components/assets/img/nestle.jpg)
...
![Peti chef](./src/components/assets/img/petichef.png)
...
![Cookpad](./src/components/assets/img/cookpad.jpg)
...
![Benchamark1](./src/components/assets/img/benchmark1.png)

![Benchamark2](./src/components/assets/img/benchmark2.png)
...
![Resultado 1](./src/components/assets/img/result1.png)

![Resultado 2](./src/components/assets/img/result2.png)

![Resultado 3](./src/components/assets/img/result3.png)
...
![User Flow](./src/components/assets/img/userflowMiSazon.png)
...
![Sketch Login Básico](./src/components/assets/img/sketchloginbasico.jpeg)
...
![Image Login Básico](./src/components/assets/img/loginbasico.png)
...
![Sketch1](./src/components/assets/img/sketch1.jpg)
...
* Luego, se paso a diseñar la interfaz con ayuda de una herramienta de diseño visual Figma, como se puede apreciar a continuación:
 ...
 ![Image Login 1](./src/components/assets/img/login1.png)
...
![Sketch Login 2](./src/components/assets/img/sketchlogin2.jpg)



![Sketch Login 3](./src/components/assets/img/sketchlogin3.jpg)


* Luego, se paso a diseñar la interfaz con ayuda de una herramienta de diseño visual Figma, como se puede apreciar a continuación:

 ![Image Login 2](./src/components/assets/img/login2.png)


 ![Image Login 3](./src/components/assets/img/login3.png)
...
* A continuación se mostrarán los sketches a lapiz y papel:
 ...
 ![Sketch Muro 1](./src/components/assets/img/sketchmuro1.jpg)



 ![Sketch Muro 2](./src/components/assets/img/sketchmuro2.jpg)


* Finalinzando con la utilización de la herramienta (Figma):

![Image Muro 1](./src/components/assets/img/mobilefirstscreen.png)


![Image Muro 2](./src/components/assets/img/mobilesecondscreen.png)
...
![Gráfica 5](./src/components/assets/img/grafica5.png)
